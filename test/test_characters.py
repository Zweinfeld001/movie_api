...
def test_get_character():
    ...
    with open(prefix + "test/characters/7421.json", encoding="utf-8") as f:
...
def test_characters():
    ...
    with open(prefix + "test/characters/root.json", encoding="utf-8") as f:
        assert response.json() == json.load(f)
...
def test_get_character2():
    ...
    with open(prefix + "test/characters/2.json", encoding="utf-8") as f:
        assert response.json() == json.load(f)
...
def test_sort_filter():
    ...
    with open(
        prefix + "test/characters/characters-name=amy&limit=50&offset=0&sort=number_of_lines.json",
        encoding="utf-8",
    ) as f:
        assert response.json() == json.load(f)
...
def test_sort_filter2():
    ...
    with open(
        prefix + "test/characters/characters-name=space&limit=250&offset=42&sort=movie.json",
        encoding="utf-8",
    ) as f:
        assert response.json() == json.load(f)
